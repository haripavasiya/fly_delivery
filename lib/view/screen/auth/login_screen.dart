            ...
            child: Column(
              children: [
                    ...
                    Expanded(child:  RichText(
                      ...
                      text: TextSpan(children: <TextSpan>[
                        TextSpan(
                            ...
                            style: poppinsRegular.copyWith(fontSize: AppConstants.itemWidth*0.028,color: ColorResources.BLACK)),

                        TextSpan(
                          text: "Privacy Policy",
                          style: poppinsMedium.copyWith( fontSize: AppConstants.itemWidth*0.028,color: ColorResources.COLOR_PRIMERY),
                        ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Don’t have an account? ",style: poppinsRegular.copyWith(fontSize: AppConstants.itemWidth*0.035, color: ColorResources.BLACK),),
                    GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => const RegistrationScreen()));
                        },
                        child: Text("Sign Up",style: poppinsMedium.copyWith(fontSize: AppConstants.itemWidth*0.035, color: ColorResources.COLOR_PRIMERY),)),
                  ],
                ),
              ],
            ),
